...
EmployeeDashBoard::EmployeeDashBoard(): wxFrame(NULL, wxID_ANY, "EmployeeDashBoard") {};
EmployeeDashBoard::EmployeeDashBoard(Hotel *hotel): wxFrame(NULL, wxID_ANY, "EmployeeDashBoard") {
    this->myHotel = hotel;
...
///Left side of splitter
    ...
    wxStaticText *reservation_label = new wxStaticText(left, wxID_ANY, "Edit Reservations");
